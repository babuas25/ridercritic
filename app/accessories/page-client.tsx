...
// JSON-LD structured data for the accessories page
const generateJsonLd = () => {
  return {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Motorcycle Accessories",
    "description": "Customize and enhance your motorcycle with premium accessories",
    "itemListElement": sampleAccessories.map((accessory, index) => ({
      "@type": "ListItem",
      "position": index + 1,
      "item": {
        "@type": "Product",
